  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        scroll: "scroll 30s linear infinite", // Added infinite scroll animation for logo carousel
      },
      fontFamily: {
        light: ["var(--font-poppins-light)", "sans-serif"],
        medium: ["var(--font-poppins-medium)", "sans-serif"], // Keep medium for backwards compatibility but not actively used
      },
      boxShadow: {
        button:
